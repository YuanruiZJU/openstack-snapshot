...
class ComputeAPI(object):
    ...
    # Added by YuanruiFan. We add these functions to give the external 
    # snapshot function for the vm.
    def light_snapshot_instance(self, ctxt, instance):
        version = '4.0'
        cctxt = self.client.prepare(server=_compute_host(None, instance),
                version=version)
    ...
    def light_recover_instance(self, ctxt, instance, use_root=False, snap_index=None):
        version = '4.0'
        cctxt = self.client.prepare(server=_compute_host(None, instance),
                version=version)
        cctxt.cast(ctxt, 'light_recover_instance',
                   instance=instance, use_root=use_root, snap_index=snap_index)
    ...
    def store_snapshot_init(self, ctxt, instance):
        version = '4.0'
        cctxt = self.client.prepare(server=_compute_host(None, instance),
                version=version)
        cctxt.cast(ctxt, 'store_snapshot_init',
                   instance=instance)
    ...
    def light_snapshot_all(self, ctxt, host, daily=False):
        version = '4.0'
        cctxt = self.client.prepare(server=_compute_host(host, None),
                version=version)
        cctxt.cast(ctxt, 'light_snapshot_all', daily=daily)
