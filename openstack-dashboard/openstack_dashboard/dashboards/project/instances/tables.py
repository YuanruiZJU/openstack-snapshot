...
# Added by YuanruiFan. 
DISABLE_LIGHT_SNAPSHOT=0
ENABLE_LIGHT_SNAPSHOT=1
...
#Added by YuanruiFan. Add a button for enable light-snapshot
class ToggleEnableLightSnapshot(tables.BatchAction):
    name = "enable_light_snapshot"
    icon = "enable_light_snapshot"
...
class LightSnapshotInstance(policy.PolicyTargetMixin, tables.BatchAction):
    ...
    def action_past(count):
        return ungettext_lazy(
            u"Light Snapshot Instance Successfully",
            u"Light Snapshot Instances Successfully",
            count
        )
